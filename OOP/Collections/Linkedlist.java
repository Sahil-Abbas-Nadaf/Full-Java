...
public class Linkedlist{
    ...
    // LinkedList<Integer> list = new LinkedList<Integer>(); --> This ok for making 
    // LinkedList in java
    // Another way is to making LinkedList is : shown in below
    LinkedList<Integer> list = new LinkedList<>();//==> this is also ok to make LinkedList
